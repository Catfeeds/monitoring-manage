    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info">
                ...
                <form id="post-form" class="form-horizontal" action="{{ route('admin::labels.store') }}" method="post" enctype="multipart/form-data" pjax-container>
                    {{ csrf_field() }}
                    <div class="box-body">
                        <div class="form-group">
                            <label for="title" class="col-sm-2 control-label">标签名</label>
                            <div class="col-sm-3">
                                <input type="text" id="name" name="name" class="form-control title" placeholder="输入 标签名">
                            </div>
                            <label for="title" class="col-sm-2 control-label">排序</label>
                            <div class="col-sm-3">
                                <input type="text" id="sort" name="sort" value="0" class="form-control title" placeholder="输入 排序">
                            </div>
                        </div>
