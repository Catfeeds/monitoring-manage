    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info">
                ...
                <form id="post-form" class="form-horizontal" action="{{ route('admin::cameras.store') }}" method="post" enctype="multipart/form-data" pjax-container>
                    {{ csrf_field() }}
                    <div class="box-body">
                        <div class="form-group">
                            <label for="title" class="col-sm-2 control-label">uid</label>
                            <div class="col-sm-8">
                                <input type="text" id="uid" name="uid" class="form-control title" placeholder="输入 uid">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" id="area" name="area" class="form-control area" placeholder="输入 摄像头名称">
                                <span style="color: orangered;">名称例子：走廊视频</span>
                            </div>
                        </div>
