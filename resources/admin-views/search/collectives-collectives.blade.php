<div class="modal fade" id="filter-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin::collectives.index') }}" method="get" pjax-container>
                <div class="modal-body">
                    <div class="form">
                        ...
                        <div class="form-group">
                            <label>班级名称</label><input type="text" class="form-control" placeholder="班级名称" name="name" value="{{ request('name') }}">
                        </div>
