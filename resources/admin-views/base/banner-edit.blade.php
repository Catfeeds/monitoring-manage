    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info">
                ...
                <form id="post-form" class="form-horizontal" action="{{ route('admin::platBanners.update', $platBanner->id) }}" method="post" enctype="multipart/form-data" pjax-container>
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <input type="text" id="order" name="order" value="{{ $platBanner->order }}" class="form-control order" placeholder="输入 排序">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="fields-group">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="file" class="banner" name="banner" id="banner" data-initial-preview="{{ $platBanner->cover }}" data-initial-caption="{{ basename($platBanner->cover) }}" accept="image/*">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <select class="form-control type" style="width: 100%;" id="select-type" name="link_type" data-placeholder="选择 类型"  >
                                        @foreach($link_types as $k => $type)
                                            ...
                                            <option value="{{ $k }}" @if($platBanner->link_type == $k) selected @endif>{{ $type }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group" style="width: 100%">
                                    ...
                                    <input type="hidden" id="target" name="link" value="{{ $platBanner->link }}" class="form-control target" placeholder="输入 目标">
                                    <input type="text" id="faker_target" name="faker_target"  @if($platBanner->link_type == 'url') value = "{{ $platBanner->target_2 }}" @else value = "您选择的是：{!! $bannerPresenter->showTitle($platBanner) !!}" @endif class="form-control target" placeholder="输入 目标">
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="checkbox" class="status la_checkbox" @if($platBanner->status) checked @endif/>
                                <input type="hidden" class="status" name="status" value="{{ $platBanner->status }}"/>
                            </div>
                        </div>
                    </div>
