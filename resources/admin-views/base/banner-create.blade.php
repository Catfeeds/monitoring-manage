    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info">
                ...
                <form id="post-form" class="form-horizontal" action="{{ route('admin::platBanners.store') }}" method="post" enctype="multipart/form-data" pjax-container>
                    {{ csrf_field() }}
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group" style="width: 100%">
                                    ...
                                    <input type="hidden" id="target" name="link" class="form-control target">
                                    <input type="text" id="faker_target"  name="faker_target" class="form-control" placeholder="填入链接目标" style="width: 100%;">
                                </div>
