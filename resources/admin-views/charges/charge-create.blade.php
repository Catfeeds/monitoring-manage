    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info">
                ...
                <form id="post-form" class="form-horizontal" action="{{ route('admin::charges.store') }}" method="post" enctype="multipart/form-data" pjax-container>
                    {{ csrf_field() }}
                    <div class="box-body">
                        <div class="form-group">
                            <label for="title" class="col-sm-2 control-label">收费价格</label>
                            <div class="col-sm-3">
                                <input type="text" id="money" name="money" class="form-control title" placeholder="输入 收费价格">
                            </div>
                            <label for="title" class="col-sm-2 control-label">收费时长</label>
                            <div class="col-sm-3">
                                <input type="text" id="time" name="time" class="form-control title" placeholder="输入 收费时长">
                            </div>
                        </div>
