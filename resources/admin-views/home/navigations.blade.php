                    ...
                    <table class="table">
                        ...
                        @foreach($navigations as $navigation)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin::navigations.edit', $navigation->id) }}"  role="button" class="btn btn-info btn-sm">
                                        <i class="fa fa-edit"></i>编辑
                                    </a>
                                    <a href="javascript:void(0);" data-id="{{ $navigation->id }}" class="btn btn-danger btn-sm grid-row-delete">
