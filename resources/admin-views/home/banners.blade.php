                        ...
                        @foreach($banners as $key => $banner)
                            <tr>
                                ...
                                <td style="vertical-align:middle;">
                                    <a href="{{ route('admin::banners.edit', $banner->id) }}" style="padding:3px 6px;" class="btn btn-info btn-sm" role="button">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="javascript:void(0);" data-id="{{ $banner->id }}" data-url="{{ route('admin::banners.destroy',$banner->id) }}" style="padding:3px 6px;" class="btn btn-danger btn-sm grid-row-delete" role="button">
