                                ...
                                <div class="input-group" style="width: 100%">
                                    <div id="http" class="input-group-btn" style="display: none;">
                                        <select name="http" class="btn btn-default" style="background-color: white;">
                                            <option value="1" {{ $navigation->type }}>http://</option>
                                            <option value="2">https://</option>
                                        </select>
                                    </div>
                                    <input type="hidden" id="target" name="target" value="{{ $navigation->target_2 }}" class="form-control target" placeholder="输入 目标">
                                    <input type="text" id="faker_target" name="faker_target" value=" {{ $navigation->target_2 }}"  class="form-control target" placeholder="输入 目标">
                                </div>
